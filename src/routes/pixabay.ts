...
const EXERCISE_SEARCH: Record<string, string> = {
  ...
  "Bear Crawls":                    "bear crawl core exercise fitness",
  "Bird Dogs":                      "bird dog core back exercise",
  "Incline Push-Ups":               "incline push up exercise fitness",
  "Chair Squats":                   "squat chair exercise fitness",
  "Curtsy Lunges":                  "curtsy lunge glute exercise",
  "Split Squats":                   "split squat lunge exercise",
  "Calf Raise Pulses":              "calf raise exercise legs",
  "Dumbbell Romanian Deadlifts":    "romanian deadlift dumbbell hamstring exercise",
  "Bent-Over Reverse Fly":          "reverse fly rear delt exercise",
  "Front Raises":                   "front raise shoulder exercise",
  "Lateral Raises":                 "lateral raise shoulder exercise",
  "Hammer Curls":                   "hammer curl bicep exercise",
  "Overhead Tricep Extension":      "overhead tricep extension dumbbell exercise",
  "Glute Bridge March":             "glute bridge march core exercise",
  "Fire Hydrants":                  "fire hydrant hip exercise",
  "Clamshells":                     "clamshell hip exercise resistance band",
  "High Plank Shoulder Taps":       "plank shoulder tap core exercise",
  "Standing Resistance Band Kickbacks": "resistance band glute kickback exercise",
  "Wall Push-Ups":                  "wall push up exercise beginner",
  "Pallof Press":                   "resistance band core exercise stability",
  "Band Pull-Aparts":               "resistance band pull apart shoulder exercise",
  // Stretches
  ...
  "Wrist Flexor Stretch":           "wrist stretch forearm yoga",
  "Wrist Extensor Stretch":         "wrist stretch forearm yoga",
  "Cross-Body Shoulder Stretch":    "shoulder cross body stretch yoga",
  "Overhead Tricep Stretch":        "tricep overhead stretch yoga",
  "Lat Stretch":                    "lat stretch back yoga",
  "Side Bend Stretch":              "side bend stretch yoga",
  "Standing IT Band Stretch":       "IT band stretch hip yoga",
  "Kneeling Adductor Stretch":      "inner thigh adductor stretch yoga",
  "Frog Stretch":                   "frog pose inner thigh yoga stretch",
  "Happy Baby":                     "happy baby pose yoga stretch",
  "Pigeon Pose":                    "pigeon pose hip yoga stretch",
  "Half Split Stretch":             "half split hamstring yoga stretch",
  "Seated Hamstring Fold":          "seated hamstring stretch yoga",
  "Standing Side Lunge Stretch":    "side lunge inner thigh stretch",
  "Ankle Circles":                  "ankle mobility stretch yoga",
  "Toe Touch Reach":                "forward fold toe touch stretch yoga",
  "Downward Dog Calf Pedal":        "downward dog yoga calf stretch",
  "Cobra Stretch":                  "cobra pose yoga backbend stretch",
  "Sphinx Pose":                    "sphinx pose yoga back stretch",
  "Kneeling Chest Opener":          "kneeling chest opener yoga stretch",
  "Wall Pec Stretch":               "pec chest wall stretch yoga",
  "Scorpion Stretch":               "scorpion stretch hip rotation yoga",
  "World's Greatest Stretch":       "worlds greatest stretch hip mobility yoga",
  "Prone Quad Stretch":             "prone quad stretch yoga",
  "Reclined Bound Angle":           "reclined bound angle yoga hip stretch",
  "Eagle Arms":                     "eagle arms yoga shoulder stretch",
  "Levator Scapulae Stretch":       "neck levator scapulae stretch yoga",
  "Jaw Release Stretch":            "jaw neck relaxation stretch",
  "Seated Side Reach":              "seated side stretch yoga",
  "Diaphragm Rib Stretch":          "breathing diaphragm rib stretch yoga",
};
